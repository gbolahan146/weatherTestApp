...
List<int> listOfWeatherTempMin;
List<int> listOfWeatherTempMax;
...
class _TomorrowWeatherListViewState extends State<TomorrowWeatherListView> {
  ...
  void getHourlyForecastForTomorrow() async {
    ...
    listOfWeatherTempMin = List();
    listOfWeatherTempMax = List();
  ...
  int mTempMin({int currentIndex}) {
    var temperature =
        mListOfHourlyWeatherDataForTomorrow[currentIndex]['main']['temp_min'];
    _temp = temperature.toInt();
    listOfWeatherTempMin.add(_temp);
    return _temp;
  }
  int mTempMax({int currentIndex}) {
    var temperature =
        mListOfHourlyWeatherDataForTomorrow[currentIndex]['main']['temp_max'];
    _temp = temperature.toInt();
    listOfWeatherTempMax.add(_temp);
    return _temp;
  }

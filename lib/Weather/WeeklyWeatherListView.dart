...
List<int> mListOfWeeklyWeatherTempMin = List();
List<int> mListOfWeeklyWeatherTempMax = List();
...
int getTempMin({int currentIndex}) {
  var eachWeatherTemp = mListOfWeeklyForecast[currentIndex]['main']['temp_min'];
  var _temp = eachWeatherTemp.toInt();
  mListOfWeeklyWeatherTempMin.add(_temp);

  return _temp;
}

int getTempMax({int currentIndex}) {
  var eachWeatherTemp = mListOfWeeklyForecast[currentIndex]['main']['temp_max'];
  var _temp = eachWeatherTemp.toInt();
  mListOfWeeklyWeatherTempMax.add(_temp);
